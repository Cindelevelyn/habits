...
interface Props extends TouchableOpacityProps {
  ...
  completedOfHabits?: number,
  date: Date
}

export function HabitDay({ amountOfHabits = 0, completedOfHabits = 0, date, ...rest }: Props) {
  const amountAccomplishedPercentage = amountOfHabits > 0 ? generateProgressPercentage(amountOfHabits, completedOfHabits) : 0
